    ...
    <div class="cat-block">
      <div class="cat-header">
        ...
        <div class="cat-icon-box ${meta.colorClass}" style="border-radius:50%; padding:4px;">
          <i class="icon ${meta.icon}" style="background-color:white; -webkit-mask: url(${meta.icon}) no-repeat center;"></i>
        </div>
...
/* =========================================
   5. DOWNLOAD FUNCTIONS (PDF FIXED)
   ========================================= */
...
function downloadPDF() {
  ...
  const opt = {
    ...
    html2canvas: {
      ...
      useCORS: true,
      scrollY: 0,
      windowWidth: 1240, // Force canvas to match page width
    },
    // FORMAT: Match CSS 1240x1754 exactly
    jsPDF: {
      unit: "px",
      format: [1240, 1754],
      orientation: "portrait",
    },
    // PAGEBREAK: Use legacy mode which respects page-break-after: always

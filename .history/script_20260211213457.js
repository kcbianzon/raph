...
function renderKPICard(cat, containerId) {
  ...
  // 2. Find Metadata (Icon & Title)
  // We match the JSON title to our META keys
  const metaKey =
  ...
  // Green starts at 12 o'clock (0). Yellow follows Green. Red follows Yellow.
  ...
  // 4. Generate HTML
  // We place labels explicitly: Pos (Right), Neg (Left), Neu (Bottom)
  const html = `
    <div class="kpi-card">
      <div class="kpi-head">
